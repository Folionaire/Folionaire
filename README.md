...
- Capital losses offset against gains before the 50% discount, following ATO rules
...
- **Exit Strategy:** What to sell at 2x, 3x or any multiple to recover your original investment and hold the rest for free, plus laddered exits and trimming to a target allocation
- **Wealth Plan:** Your FI number, the year you reach it, and whether your outside-super portfolio bridges the gap to preservation age
- **Budget:** Income vs expenses vs invested, weekly through yearly, with spending by category
- **Portfolio Risk Scan:** Scores concentration, diversification, asset mix, crypto risk, loss control, income and currency exposure
